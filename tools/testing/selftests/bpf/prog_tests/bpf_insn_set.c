...
static void check_relocate_simple(void)
{
	...
	int prog_fd = -1, map_fd;
	long map_in[] = {0, 1, 2, 3, 4, 5};
	long map_out[] = {0, 1, 4, 5, 8, 9};
	long val;
	int i;
...
static void check_relocate_with_functions(void)
{
	...
	int prog_fd = -1, map_fd;
	long map_in[] =  { 0, 1,  2, 3, 4, 5, /* func */  6, 7,  8, 9, 10};
	long map_out[] = {-1, 0, -1, 3, 4, 5, /* func */ -1, 6, -1, 9, 10};
	long val;
	int i;
