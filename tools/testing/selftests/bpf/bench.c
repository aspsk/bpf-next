...
extern struct argp bench_wildcard_lookup_argp;
...
static const struct argp_child bench_parsers[] = {
	...
	{ &bench_wildcard_lookup_argp, 0, "Wildcard lookup benchmark", 0 },
	{},
};
...
extern const struct bench bench_bpf_wildcard_lookup;
