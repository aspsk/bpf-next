...
extern struct argp bench_hashmap_new_lookup_argp;
...
static const struct argp_child bench_parsers[] = {
	...
	{ &bench_hashmap_new_lookup_argp, 0, "Hashmap v2 lookup benchmark", 0 },
...
extern const struct bench bench_bpf_hashmap_new_lookup;
