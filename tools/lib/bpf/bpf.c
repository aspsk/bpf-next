...
{
	const size_t attr_sz = offsetofend(union bpf_attr, bind_fd_array_cnt);
	...
	attr.bind_fd_array = ptr_to_u64(OPTS_GET(opts, bind_fd_array, NULL));
	attr.bind_fd_array_cnt = OPTS_GET(opts, bind_fd_array_cnt, 0);
