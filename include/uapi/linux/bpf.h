...
enum {
	BPF_WILDCARD_KEY_MATCH = 0,
	BPF_WILDCARD_KEY_RULE,
};
...
#define __BPF_WILDCARD_DATA_RULE_6(TYPE, T, FIELD, ...) __BPF_WILDCARD_DATA__ ## TYPE (T, FIELD); __BPF_WILDCARD_DATA_RULE_5(__VA_ARGS__)
#define __BPF_WILDCARD_DATA_RULE_7(TYPE, T, FIELD, ...) __BPF_WILDCARD_DATA__ ## TYPE (T, FIELD); __BPF_WILDCARD_DATA_RULE_6(__VA_ARGS__)
#define __BPF_WILDCARD_DATA_RULE_8(TYPE, T, FIELD, ...) __BPF_WILDCARD_DATA__ ## TYPE (T, FIELD); __BPF_WILDCARD_DATA_RULE_7(__VA_ARGS__)
#define __BPF_WILDCARD_DATA_RULE_9(TYPE, T, FIELD, ...) __BPF_WILDCARD_DATA__ ## TYPE (T, FIELD); __BPF_WILDCARD_DATA_RULE_8(__VA_ARGS__)
...
#define __BPF_WILDCARD_DATA_ELEM_6(TYPE, T, FIELD, ...) T FIELD; __BPF_WILDCARD_DATA_ELEM_5(__VA_ARGS__)
#define __BPF_WILDCARD_DATA_ELEM_7(TYPE, T, FIELD, ...) T FIELD; __BPF_WILDCARD_DATA_ELEM_6(__VA_ARGS__)
#define __BPF_WILDCARD_DATA_ELEM_8(TYPE, T, FIELD, ...) T FIELD; __BPF_WILDCARD_DATA_ELEM_7(__VA_ARGS__)
#define __BPF_WILDCARD_DATA_ELEM_9(TYPE, T, FIELD, ...) T FIELD; __BPF_WILDCARD_DATA_ELEM_8(__VA_ARGS__)
...
#define __BPF_WILDCARD_RULE_DESC_6(TYPE, T, FIELD, ...) __BPF_WILDCARD_RULE_DESC(TYPE, T, FIELD); __BPF_WILDCARD_RULE_DESC_5(__VA_ARGS__)
#define __BPF_WILDCARD_RULE_DESC_7(TYPE, T, FIELD, ...) __BPF_WILDCARD_RULE_DESC(TYPE, T, FIELD); __BPF_WILDCARD_RULE_DESC_6(__VA_ARGS__)
#define __BPF_WILDCARD_RULE_DESC_8(TYPE, T, FIELD, ...) __BPF_WILDCARD_RULE_DESC(TYPE, T, FIELD); __BPF_WILDCARD_RULE_DESC_7(__VA_ARGS__)
#define __BPF_WILDCARD_RULE_DESC_9(TYPE, T, FIELD, ...) __BPF_WILDCARD_RULE_DESC(TYPE, T, FIELD); __BPF_WILDCARD_RULE_DESC_8(__VA_ARGS__)
...
#define BPF_WILDCARD_DESC_6(...) BPF_WILDCARD_DESC_x(6, __VA_ARGS__)
#define BPF_WILDCARD_DESC_7(...) BPF_WILDCARD_DESC_x(7, __VA_ARGS__)
#define BPF_WILDCARD_DESC_8(...) BPF_WILDCARD_DESC_x(8, __VA_ARGS__)
#define BPF_WILDCARD_DESC_9(...) BPF_WILDCARD_DESC_x(9, __VA_ARGS__)
